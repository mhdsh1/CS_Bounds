...
# CSbounds + DistDiD in one figure ... Skip this for now 
...
lines(R,FY10TUBCS,xlim=c(0,15),ylim=c(0,0.25),col="blue",lty=1)
lines(R,FY10TLBCSm,xlim=c(0,50),ylim=c(0,1),col="red",lty=1)
legend("topleft",c("CS-LB","CS-UB","DistDiD"),cex=1.25,col=c("red","blue","blue4"),
lty=c(1,1,1))
dev.off()
...
write.csv(boundsSBS,
paste0(
  output_path, sprintf("bounds_computation_wages_disaggregated06272024_",Tperiod,".csv")
  )
)
