...
- CPS_cleaned_merged_deflated_07_15.csv
- CPS_cleaned_deflated_merged_yearly.csv

I need to check with Dalia which one is used to create the Figure 2 in Paper
...
save "${output}/data/yearly_minwage_increase.dta", replace //Save yearly minimum wage increase
...
save "${output}/data/minwage_increase_10_15.dta", replace //Save ever minimum wage increase
...
merge m:1 statenum using "${output}/data/minwage_increase_10_15.dta", nogenerate 
...
//merge with yearly unemployment by state
merge m:1 statenum year using "${output}/data/yearly_minwage_increase.dta", ///
nogenerate keepusing(state_mw)

keep if year == 2007 | year == 2010 | year == 2015
save "${output}/data/CPS_cleaned_merged_07_15.dta", replace
export delimited "${output}/data/CPS_cleaned_merged_07_15.csv", replace
...
keep if year == 2007 | year == 2010 | year == 2015
save "${output}/data/CPS_cleaned_merged_deflated_07_15.dta", replace
export delimited "${output}/data/CPS_cleaned_merged_deflated_07_15.csv", replace
...
merge m:1 statenum year using "${output}/data/yearly_minwage_increase.dta", nogenerate 
...
save "${output}/data/CPS_cleaned_merged_yearly.dta", replace
export delimited "${output}/data/CPS_cleaned_merged_yearly.csv", replace
...
keep if year > 2005 | year < 2018 //Remove all the years from the 90s
save "${output}/data/CPS_cleaned_deflated_merged_yearly.dta", replace
export delimited "${output}/data/CPS_cleaned_deflated_merged_yearly.csv", replace
