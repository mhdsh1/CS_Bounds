...
log using "$path/code/ado_gini", replace    // Open log file
...
real scalar square(real scalar u) {
    ...
    printf("G11T is %f\n", G11T)
//    printf("G10TCSLB is %f\n", G10TCSLB)
//    printf("G10TCSUB is %f\n", G10TCSUB)
//    printf("G10TDDID is %f\n", G10TDDID)

//    printf("GQY11T`u' is %f\n",GQY11Tu) 
//    printf("GQCSLB`u' is %f\n",GQCSLBu)
//    printf("GQCSUB`u' is %f\n",GQCSUBu)
//    printf("GQDDID`u' is %f\n",GQDDIDu)
