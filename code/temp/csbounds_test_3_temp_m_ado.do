...
/*    
	for (i = 1; i <= rows(p); i++) {
        ...
        if (sum(cond) > 0) {
		    EY10TCSLB = EY10TCSLB + QY10TCSLB[i] 
            }
        }
	...
	for (i = 1; i <= rows(p); i++) {
        ...
        if (sum(cond) > 0) {
		    EY10TCSUB = EY10TCSUB + QY10TCSUB[i] 
            }
        }		
	...
	for (i = 1; i <= rows(p); i++) {
        ...
        if (sum(cond) > 0) {
		    EY10TDDID = EY10TDDID + QY10TDDID[i] 
            }
        }
*/
	EY10TCSLB = EY10TCSLB*pgrid	
    EY10TCSUB = EY10TCSUB*pgrid
	EY10TDID  = EY00T+EY10C-EY00C
	EY10TDDID = EY10TDDID*pgrid
	
	round(EY11T,0.01) 
    round(EY11T - EY10TCSLB,0.01)
    round(EY11T - EY10TCSUB, 0.01)
	round(EY11T - EY10TDID, 0.01)
    round(EY11T - EY10TDDID, 0.01)
	...
	round(EQY11Tu, 0.01)
	round(EQY11Tu - EQY10TCSLBu, 0.01)
	round(EQY11Tu - EQY10TCSUBu, 0.01)
	round(EQY11Tu - EQY10TDDIDu, 0.01)

end
  
//end // end of body of ado file 
