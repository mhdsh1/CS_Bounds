...
program gini, rclass
    ...
    global Rmax = 2*(1 + r(max))
    //global Rmax = 2*858.14
...
mata: square(`u')
matrix colnames result = "G11T" "G10TCSLB" "G10TCSUB" "G10TDDID"
matrix list result
...
mata:
real matrix square(real scalar u) {
...
// Table 2 Results //
    ...
    G10TCSLB = round(G10TCSLB-G11T, 0.01)
    G10TCSUB = round(G10TCSUB-G11T, 0.01) 
    G10TDDID = round(G10TDDID-G11T, 0.01)
